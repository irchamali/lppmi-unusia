...
use App\Models\AksModel;
// use App\Models\DocsCategoryModel;

class AksAdminController extends BaseController
{
    public function __construct()
    {
        $this->inboxModel = new InboxModel();
        $this->commentModel = new CommentModel();
        $this->aksModel = new AksModel();
    ...
    public function index()
    {
        ...
        $data = [
            ...
            // 'categories' => $this->akscategoryModel->findAll(),
            'akreditasi' => $this->aksModel->findAll()
        ];
