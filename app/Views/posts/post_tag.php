        ...
        <div class="row pt-6">
            <div class="col-md-8 text-white" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                <div class="overflow-hidden">
                    <h1 class="text-white fs-4 fs-md-5 mb-0 lh-1" data-zanim-xs='{"delay":0}'>Tag Posts</h1>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-auto mx-auto mt-4">
                <nav class="mt-4" aria-label="Tag pagination">
                    <?= $pager->links('tag_posts', 'post_pagination'); ?>
                </nav>
            </div>
        </div>
    </div>
