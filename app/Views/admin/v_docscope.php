...
<body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-white">
                            <div class="panel-body">
                                <button type="button" class="btn btn-success m-b-sm" data-toggle="modal" data-target="#myModal">Add New Scope</button>
                                        ...
                                        <tbody id="body-table">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $row['scope_slug']; ?></td>
                                                    <td style="text-align: center;">
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-edit" data-id="<?= $row['scope_id']; ?>" data-scope="<?= $row['scope_name']; ?>" data-description="<?= $row['scope_description']; ?>"><span class="fa fa-pencil"></span></a>
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-delete" data-id="<?= $row['scope_id']; ?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <!--ADD RECORD MODAL-->
    <form action="/<?= session('role'); ?>/docscope" method="POST">
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">New Scope</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="text" name="scope" class="form-control" placeholder="Scope Name (e.g. Universitas, Fakultas)" required>
                        </div>
                        <div class="form-group">
        ...
        <div class="modal fade" id="EditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="text" name="scopeedit" class="form-control" placeholder="Scope Name" required>
                        </div>
                        <div class="form-group">
        ...
        <div class="modal fade" id="DeleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Delete Scope</h4>
                    </div>
                    <div class="modal-body">
